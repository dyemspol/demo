    ...
    employees: [
        {
            ...
            status: "active",
            phone: "09171234567",
            email: "maria.santos@groceryhub.ph",
        },
        {
            id: 2,
            name: "Juan Dela Cruz",
            ...
            status: "active",
            phone: "09181234567",
            email: "juan.delacruz@groceryhub.ph",
        },
        {
            id: 3,
            name: "Ana Reyes",
        ...
        },
        {
            ...
            status: "active",
            phone: "09321234567",
            email: "pedro.garcia@groceryhub.ph",
        },
        {
            id: 5,
            name: "Carmen Lopez",
            ...
            status: "active",
            phone: "09331234567",
            email: "carmen.lopez@groceryhub.ph",
        },
        {
            id: 6,
            ...
            status: "active",
            phone: "09341234567",
            email: "roberto.mendoza@groceryhub.ph",
        },
        {
            id: 7,
            ...
            status: "active",
            phone: "09821234567",
            email: "linda.fernandez@groceryhub.ph",
        },
        {
            id: 8,
            name: "Carlos Ramos",
            ...
            status: "active",
            phone: "09831234567",
            email: "carlos.ramos@groceryhub.ph",
        },
        {
            id: 9,
            name: "Sofia Torres",
            ...
            status: "active",
            phone: "09841234567",
            email: "sofia.torres@groceryhub.ph",
        },
        {
            id: 10,
            name: "Miguel Cruz",
            ...
            status: "active",
            phone: "09281234567",
            email: "miguel.cruz@groceryhub.ph",
        },
        {
            id: 11,
            name: "Elena Morales",
            ...
            status: "on-leave",
            phone: "09291234567",
            email: "elena.morales@groceryhub.ph",
        },
        {
            id: 12,
            name: "Diego Herrera",
            ...
            status: "active",
            phone: "09201234567",
            email: "diego.herrera@groceryhub.ph",
        },
    ],
};
    ...
    sampleData.inventory.forEach((item) => {
        ...
        row.innerHTML = `
            ...
            <td>
                ...
                <button class="btn btn-sm btn-outline" onclick="deleteProduct('${
                    item.product
                }')">Delete</button>
            </td>
        `;
...
function initOperatingHours() {
    ...
    if (branchSelector && openingTime && closingTime && minStockAlert) {
        ...
        minStockAlert.addEventListener("change", () =>
            saveBranchSettings(branchSelector.value)
        );
...
function saveBranchSettings(branch) {
    ...
    console.log(
        `Settings saved for ${branch} branch: ${formatTime(
            openingTime
        )} - ${formatTime(closingTime)}, Min Stock: ${minStockAlert}`
    );
}
